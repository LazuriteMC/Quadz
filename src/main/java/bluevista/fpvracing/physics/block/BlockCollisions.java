package bluevista.fpvracing.physics.block;
...
public class BlockCollisions {
     ...
     */
    public static Set<Block> getTouchingBlocks(FlyableEntity entity, Direction... directions) {
        PhysicsWorld physicsWorld = ClientInitializer.physicsWorld;
        ClientEntityPhysics physics = (ClientEntityPhysics) entity.getPhysics();
