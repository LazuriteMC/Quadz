...
import dev.lazurite.fpvracing.client.render.model.QuadcopterModel;
...
public class QuadcopterRenderer extends EntityRenderer<QuadcopterEntity> {
    public static final Identifier quadTexture = new Identifier(FPVRacing.MODID, "textures/entity/drone.png");
    ...
    public static void register() {
        EntityRendererRegistry.INSTANCE.register(FPVRacing.QUADCOPTER_ENTITY,(entityRenderDispatcher, context)->new QuadcopterRenderer(entityRenderDispatcher));
    }
