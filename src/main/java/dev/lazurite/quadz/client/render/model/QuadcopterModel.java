...
public class QuadcopterModel extends AnimatedGeoModel<QuadcopterEntity> {
    ...
    @Override
    public ResourceLocation getModelResource(QuadcopterEntity quadcopter) {
        return new ResourceLocation(Quadz.MODID, quadcopter.getTemplate());
    }

    @Override
    public ResourceLocation getTextureResource(QuadcopterEntity quadcopter) {
        return new ResourceLocation(Quadz.MODID, quadcopter.getTemplate());
    }

    @Override
    public ResourceLocation getAnimationResource(QuadcopterEntity quadcopter) {
        return new ResourceLocation(Quadz.MODID, quadcopter.getTemplate());
    }
